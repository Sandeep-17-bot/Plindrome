...
form.addEventListener("submit", function (e) {
  ...
  myVar = setTimeout(gif, 3800)

  document.getElementById('output').innerHTML = "<img src='https://media.tenor.com/images/8d483e909ec3618f521e9700d6fbf2e1/tenor.gif' width=60% />"
